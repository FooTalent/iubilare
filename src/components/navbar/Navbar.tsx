...
export default function Navbar() {
    ...
    return (
        <>
            <div className="flex flex-wrap justify-between w-full h-[64px] shadow-md md:h-[112px] items-center mb-[10px] pt-[7px] pb-[8px] md:shadow-md 2xl:px-[120px] fixed bg-current border">
