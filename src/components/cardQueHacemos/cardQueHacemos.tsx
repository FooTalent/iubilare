...
const CardQueHacemos: React.FC<MyComponentProps> = ({ src, title, description, classStyle }) => (
  <div className= {`flex flex-col justify-center items-center w-[328px] h-auto p-[7px] bg-zinc-300 rounded-[5px] gap-[15px] md:m-0 md:bg-white md:flex md:flex-row md:w-[688px] 2xl:w-[1200px] ${classStyle}`}>
