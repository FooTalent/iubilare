...
const CardInfo: React.FC<CardInfoProps> = ({ info, url, classOptions, classTitle }) => {
  ...
  return (
    <div className={ `w-[328px]  p-[7px] border border-inherit rounded shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] md:flex md:flex-row md:gap-5 md:w-full md:items-center 2xl:gap-[65px] md:border-none md:shadow-[0_35px_60px_-15px_rgba(255,255,255)] 2xl:border-none ${classOptions}` }>
